...
# S10 RATE becomes "60", which is also the source NS string. Replace NS first
# so its broad method replacement cannot erase the newly selected RATE value.
APPLY_HFR_NS_CONFIG()
{
